...
const MichiganPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Michigan Tattoo Artists - InkConnect</title>
        <meta name="description" content="Discover the best tattoo artists and studios in Michigan. From Detroit to the Great Lakes, find your perfect artist on InkConnect." />
      </Helmet>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="text-center">
            <h1 className="text-5xl md:text-7xl font-black mb-4 leading-tight">
              Michigan's <span className="gradient-text">Great Lakes Ink</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto font-mono">
              Explore top-rated tattoo studios and artists from across the Great Lakes State.
            </p>
          </div>
