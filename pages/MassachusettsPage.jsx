...
const MassachusettsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Massachusetts Tattoo Artists - InkConnect</title>
        <meta name="description" content="Discover the best tattoo artists and studios in Massachusetts. From Boston to Cambridge, find your perfect artist on InkConnect." />
      </Helmet>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="text-center">
            <h1 className="text-5xl md:text-7xl font-black mb-4 leading-tight">
              Massachusetts' <span className="gradient-text">Bay State Ink</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto font-mono">
              Explore top-rated tattoo studios and artists from across the Bay State.
            </p>
          </div>
                    ...
                    <div className="cyber-card">
                      <div className="cyber-card-content">
                        <div className="relative mb-4">
                          <img  class="w-full h-64 object-cover" alt={`${artist.name} - Tattoo Artist`} style={{ clipPath: `polygon(0 0, 100% 0, 100% 100%, 10px 100%, 0 90%)` }} src="https://images.unsplash.com/photo-1677370160005-c48effa85432" />
